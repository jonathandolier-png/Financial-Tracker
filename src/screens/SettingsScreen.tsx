...
import { startBackgroundTracking, stopBackgroundTracking, requestPermissions } from '../lib/locationService';
...
export function SettingsScreen({ navigation }: Props) {
  ...
  const enableTracking = async () => {
    ...
    if (!ok) {
      Alert.alert(
        'Permission needed',
        'Please allow location access in Settings > Privacy > Location Services > Country Days Tracker, and set it to "Always".'
      );
      return;
    }
    await startBackgroundTracking();
    setTracking(true);
    Alert.alert('Tracking on', 'Your location is now being tracked in the background.');
  };
    ...
    <View style={styles.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scroll}>
        ...
        <View style={styles.sectionBox}>
          <Text style={styles.sectionLabel}>Background Tracking</Text>
          <View style={styles.trackingRow}>
            <View>
              <Text style={styles.trackingTitle}>GPS Location Tracking</Text>
              <Text style={styles.trackingDesc}>
                Automatically detects which country you are in.
              </Text>
            </View>
            <Pressable style={styles.enableBtn} onPress={enableTracking}>
        ...
        <Text style={styles.sectionHint}>
          Tap a country to set the maximum number of days allowed per financial year.
        </Text>
        ...
        {loading ? (
          ...
          <View style={styles.emptyState}>
            <Text style={styles.emptyText}>
              No countries tracked yet. The app will detect countries automatically as you travel.
            </Text>
          </View>
        ) : (
          summaries.map((s) => (
              ...
              <View style={styles.rowActions}>
                ...
                {s.limit ? (
                  <Pressable
                    ...
                    onPress={() => removeLimit(s.country_code)}
                  >
